...
def main():
    try:
        ...
        loader = AnimeDataLoader("/Users/lokesh/Desktop/LLMOPS project/Anime Recommender/data/anime_with_synopsis.csv" , "/Users/lokesh/Desktop/LLMOPS project/Anime Recommender/data/anime_updated.csv")
